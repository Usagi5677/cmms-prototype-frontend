...
import { USER_ASSIGNMENT_BULK_CREATE } from "../../../api/mutations";
...
export const UserAssignmentBulkCreate: React.FC<BulkAssignmentProps> = ({}) => {
  ...
  const [bulkCreate, { loading: assigning }] = useMutation(
    USER_ASSIGNMENT_BULK_CREATE,
    {
      onCompleted: (data) => {
        message.success(data.bulkCreateUserAssignment);
      },
      onError: (err) => {
        errorMessage(err, "Unexpected error during bulk create.");
      },
