...
import TransportationStatusFilter from "../../../common/TransportationStatusFilter";
  ...
  return (
    <div className={classes["pm-container"]}>
      ...
      {data?.getAllAssignedTransportation.edges.length > 0 ? (
        data?.getAllAssignedTransportation.edges.map(
