...
import { EDIT_TRANSPORTATION_SPARE_PR } from "../../../api/mutations";
import { errorMessage } from "../../../helpers/gql";
import SparePR from "../../../models/Transportation/TransportationSparePR";
import classes from "./EditTransportationSparePR.module.css";

const EditTransportationSparePR = ({ sparePR }: { sparePR: SparePR }) => {
  const [visible, setVisible] = useState(false);
  const [form] = useForm();

  const [editTransportationSparePR, { loading: loadingSparePR }] = useMutation(
...
export default EditTransportationSparePR;
