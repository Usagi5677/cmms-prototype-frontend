...
import { SET_ENTITY_SPARE_PR_STATUS } from "../../../api/mutations";
...
const EntitySparePRStatus = ({
  ...
  const [setEntitySparePRStatus, { loading: settingStatus }] =
    useMutation(SET_ENTITY_SPARE_PR_STATUS, {
      onCompleted: () => {
...
export default EntitySparePRStatus;
