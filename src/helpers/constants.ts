...
export const ENTITY_ADD_PERMISSIONS = [
  "ADD_ENTITY",
  "ADD_ENTITY_CHECKLIST",
  "ADD_ENTITY_PERIODIC_MAINTENANCE",
  "ADD_ENTITY_SPARE_PR",
  "ADD_ENTITY_REPAIR",
...
export const ENTITY_EDIT_PERMISSIONS = [
  "EDIT_ENTITY",
  "EDIT_ENTITY_CHECKLIST",
  "EDIT_ENTITY_PERIODIC_MAINTENANCE",
...
export const ENTITY_DELETE_PERMISSIONS = [
  "DELETE_ENTITY",
...
export const ENTITY_VIEW_PERMISSIONS = [
  "VIEW_ALL_ENTITY",
  "VIEW_ENTITY",
  "VIEW_ALL_ASSIGNED_ENTITY",
];

export const ENTITY_MISC_PERMISSIONS = [
  "ASSIGN_USER_TO_ENTITY",
  "UNASSIGN_USER_TO_ENTITY",
  "EDIT_ENTITY_LOCATION",
  "VERIFY_ENTITY_PERIODIC_MAINTENANCE",
];

export const DASHBOARD_PERMISSIONS = [
  "VIEW_DASHBOARD_MACHINERY_UTILIZATION",
  "VIEW_DASHBOARD_TRANSPORTS_UTILIZATION",
  "VIEW_DASHBOARD_ENTITY_UTILIZATION",
  "VIEW_DASHBOARD_MACHINERY_MAINTENANCE",
  "VIEW_DASHBOARD_TRANSPORTS_MAINTENANCE",
  "VIEW_DASHBOARD_ENTITY_MAINTENANCE",
  "VIEW_DASHBOARD_MACHINERY_PERIODIC_MAINTENANCE_TASK",
  "VIEW_DASHBOARD_TRANSPORTS_PERIODIC_MAINTENANCE_TASK",
  "VIEW_DASHBOARD_ENTITY_PERIODIC_MAINTENANCE_TASK",
  "VIEW_DASHBOARD_MY_MACHINERY_PERIODIC_MAINTENANCE_TASK",
  "VIEW_DASHBOARD_MY_TRANSPORTS_PERIODIC_MAINTENANCE_TASK",
  "VIEW_DASHBOARD_MY_ENTITY_PERIODIC_MAINTENANCE_TASK",
  "VIEW_DASHBOARD_STATUS_COUNT",
  "VIEW_DASHBOARD_ASSIGNED_MACHINERY",
  "VIEW_DASHBOARD_ASSIGNED_TRANSPORTS",
  "VIEW_DASHBOARD_ASSIGNED_ENTITY",
];
