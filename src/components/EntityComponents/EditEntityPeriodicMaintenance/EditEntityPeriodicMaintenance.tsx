...
import { EDIT_ENTITY_PERIODIC_MAINTENANCE } from "../../../api/mutations";
import UserContext from "../../../contexts/UserContext";
import { errorMessage } from "../../../helpers/gql";
import classes from "./EditEntityPeriodicMaintenance.module.css";
import moment from "moment";
import EntityPeriodicMaintenance from "../../../models/Entity/EntityPeriodicMaintenance";

const EditEntityPeriodicMaintenance = ({
  periodicMaintenance,
}: {
  ...
  ] = useMutation(EDIT_ENTITY_PERIODIC_MAINTENANCE, {
    onCompleted: () => {
...
export default EditEntityPeriodicMaintenance;
