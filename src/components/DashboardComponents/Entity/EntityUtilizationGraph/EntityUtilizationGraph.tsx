...
import classes from "./EntityUtilizationGraph.module.css";
import { GET_ALL_ENTITY_USAGE_HISTORY } from "../../../../api/queries";
...
const EntityUtilizationGraph = () => {
  ...
  const [allEntityUsageHistory, { data: history, loading }] = useLazyQuery(
  ...
  let data = () => {
    let labels = history?.allEntityUsageHistory.map((rec: any) =>
...
export default EntityUtilizationGraph;
