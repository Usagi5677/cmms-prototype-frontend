...
import { ADD_TRANSPORTATION_PERIODIC_MAINTENANCE } from "../../../api/mutations";
import UserContext from "../../../contexts/UserContext";
import { errorMessage } from "../../../helpers/gql";
import classes from "./AddTransportationPeriodicMaintenance.module.css";
...
const AddTransportationPeriodicMaintenance = ({
  ...
  ] = useMutation(ADD_TRANSPORTATION_PERIODIC_MAINTENANCE, {
    onCompleted: () => {
...
export default AddTransportationPeriodicMaintenance;
